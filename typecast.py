...
typecast_bp = Blueprint('typecast', __name__)


#typecast
url = "https://typecast.ai/api/speak"
API_TOKEN = "Bearer __pltVYScreJaFDNhLMZxhzGjBdQTn47e2GM52V3MVHKJ"
HEADERS = {
...
def start_speech_synthesis(answer):
    ...
    payload = {
    "actor_id": "6699eb0f10b8e361d6a9aba1",
    "text": answer,
    "lang": "auto",
    "tempo": 1,
    "volume": 100,
...
# 3. 파일 다운로드
def speaker_audio(speak_url, output_file="cast.wav"):
...
def transcribe_and_synthesize(clean_text):
    ...
    print("음성 저장 성공 'cast.wav'.")


@typecast_bp.route('/download_audio', methods=['GET', 'POST'])
def download_audio():
    # JSON 데이터에서 텍스트 추출
